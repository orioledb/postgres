 ...
 *
 * nbtcompare.c
 *	  Comparison functions for treeb access method.
 *
 ...
 *
 * IDENTIFICATION
 *	  src/backend/access/treeb/nbtcompare.c
 *
 * NOTES
 *
 *	These functions are stored in pg_amproc.  For each operator class
 *	defined on treebs, they compute
 *
 *				compare(a, b):
 *						< 0 if a < b,
 *						= 0 if a == b,
 ...
 *	three-way comparison code that the treeb function does.  Therefore,
 *	this file contains only treeb support for "trivial" datatypes ---
