...
PG_CMDTAG(CMDTAG_ALTER_ACCESS_METHOD_IMPLEMENTATION, "ALTER ACCESS METHOD IMPLEMENTATION", true, false, false)
...
PG_CMDTAG(CMDTAG_CREATE_ACCESS_METHOD_IMPLEMENTATION, "CREATE ACCESS METHOD IMPLEMENTATION", true, false, false)
...
PG_CMDTAG(CMDTAG_DROP_ACCESS_METHOD_IMPLEMENTATION, "DROP ACCESS METHOD IMPLEMENTATION", true, false, false)
