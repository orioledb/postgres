...
heapam_tuple_insert_with_arbiter(ResultRelInfo *rinfo, TupleTableSlot *slot,
								 CommandId cid, int options,
								 ...
								 TupleTableSlot *tempSlot)
{
	...
	while (true)
	{
		...
		/* adjust the tuple's state accordingly */
		heapam_tuple_complete_speculative(rel, slot, specToken, !specConflict);
